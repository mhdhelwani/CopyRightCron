...
ilCopyRightCronPlugin::getInstance()->includeClass('../interfaces/interface.ilCopyRightCronLogWriter.php');
/**
 * Class ilCopyRightCronBaseLogWriter
 */
abstract class ilCopyRightCronBaseLogWriter implements ilCopyRightCronLogWriter
{
