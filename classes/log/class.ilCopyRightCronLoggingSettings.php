...
/**
 * Class ilCopyRightCronLoggingSettings
 */
class ilCopyRightCronLoggingSettings implements ilLoggingSettings
{
	...
	public function getLogFile()
	{
		...
		return $this->now . 'ilCopyRightCron.log';
	}
